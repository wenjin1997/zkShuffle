...
// import {buildjubjub} from "../circuits/circomlibjs/jubjub.js"
// import * as jinjin from "../circuits/circomlibjs/jubjub.js";
...
async function compile_utility_circuits() {
  const circuit_list = ["jubjub", "elgamalDecrypt", "elgamalEncrypt", "matrix"];
